...
{
	if (!strcmp(airport, "旧金山")) { strcpy(AIRPORT, "SFO"); return; }
	if (!strcmp(airport, "洛杉矶")) { strcpy(AIRPORT, "LAX"); return; }
	if (!strcmp(airport, "澳门")) { strcpy(AIRPORT, "MFM"); return; }
	if (!strcmp(airport, "巴彦淖尔")) { strcpy(AIRPORT, "RLK"); return; }
	if (!strcmp(airport, "班加罗尔")) { strcpy(AIRPORT, "BLR"); return; }
	if (!strcmp(airport, "包头")) { strcpy(AIRPORT, "BAV"); return; }
	if (!strcmp(airport, "北海")) { strcpy(AIRPORT, "BHY"); return; }
	if (!strcmp(airport, "昌都")) { strcpy(AIRPORT, "BPX"); return; }
	if (!strcmp(airport, "常州")) { strcpy(AIRPORT, "CZX"); return; }
	if (!strcmp(airport, "朝阳")) { strcpy(AIRPORT, "CHG"); return; }
	if (!strcmp(airport, "成都")) { strcpy(AIRPORT, "CTU"); return; }
	if (!strcmp(airport, "赤峰")) { strcpy(AIRPORT, "CIF"); return; }
	if (!strcmp(airport, "赤塔")) { strcpy(AIRPORT, "HTA"); return; }
	if (!strcmp(airport, "冲绳")) { strcpy(AIRPORT, "OKA"); return; }
	if (!strcmp(airport, "达州")) { strcpy(AIRPORT, "DAX"); return; }
	if (!strcmp(airport, "大连")) { strcpy(AIRPORT, "DLC"); return; }
	if (!strcmp(airport, "大庆")) { strcpy(AIRPORT, "DQA"); return; }
	if (!strcmp(airport, "大邱")) { strcpy(AIRPORT, "TAE"); return; }
	if (!strcmp(airport, "大同")) { strcpy(AIRPORT, "DAT"); return; }
	if (!strcmp(airport, "丹东")) { strcpy(AIRPORT, "DDG"); return; }
	if (!strcmp(airport, "德里")) { strcpy(AIRPORT, "DEL"); return; }
	if (!strcmp(airport, "迪拜")) { strcpy(AIRPORT, "DXB"); return; }
	if (!strcmp(airport, "杜塞尔多夫")) { strcpy(AIRPORT, "DUS"); return; }
	if (!strcmp(airport, "敦煌")) { strcpy(AIRPORT, "DNH"); return; }
	if (!strcmp(airport, "鄂尔多斯")) { strcpy(AIRPORT, "DSN"); return; }
	if (!strcmp(airport, "法兰克福")) { strcpy(AIRPORT, "FRA"); return; }
	if (!strcmp(airport, "福冈")) { strcpy(AIRPORT, "FUK"); return; }
	if (!strcmp(airport, "福州")) { strcpy(AIRPORT, "FOC"); return; }
	if (!strcmp(airport, "釜山")) { strcpy(AIRPORT, "PUS"); return; }
	if (!strcmp(airport, "阜阳")) { strcpy(AIRPORT, "FUG"); return; }
	if (!strcmp(airport, "赣州")) { strcpy(AIRPORT, "KOW"); return; }
	if (!strcmp(airport, "广岛")) { strcpy(AIRPORT, "HIJ"); return; }
	if (!strcmp(airport, "广元")) { strcpy(AIRPORT, "GYS"); return; }
	if (!strcmp(airport, "广州")) { strcpy(AIRPORT, "CAN"); return; }
	if (!strcmp(airport, "贵阳")) { strcpy(AIRPORT, "KWE"); return; }
	if (!strcmp(airport, "桂林")) { strcpy(AIRPORT, "KWL"); return; }
	if (!strcmp(airport, "哈尔滨")) { strcpy(AIRPORT, "HRB"); return; }
	if (!strcmp(airport, "海口")) { strcpy(AIRPORT, "HAK"); return; }
	if (!strcmp(airport, "海拉尔")) { strcpy(AIRPORT, "HLD"); return; }
	if (!strcmp(airport, "杭州")) { strcpy(AIRPORT, "HGH"); return; }
	if (!strcmp(airport, "合肥")) { strcpy(AIRPORT, "HFE"); return; }
	if (!strcmp(airport, "和田")) { strcpy(AIRPORT, "HTN"); return; }
	if (!strcmp(airport, "呼和浩特")) { strcpy(AIRPORT, "HET"); return; }
	if (!strcmp(airport, "胡志明市")) { strcpy(AIRPORT, "SGN"); return; }
	if (!strcmp(airport, "黄山")) { strcpy(AIRPORT, "TXN"); return; }
	if (!strcmp(airport, "黄岩")) { strcpy(AIRPORT, "HYN"); return; }
	if (!strcmp(airport, "吉隆坡")) { strcpy(AIRPORT, "KUL"); return; }
	if (!strcmp(airport, "济南")) { strcpy(AIRPORT, "TNA"); return; }
	if (!strcmp(airport, "加德满都")) { strcpy(AIRPORT, "KTM"); return; }
	if (!strcmp(airport, "佳木斯")) { strcpy(AIRPORT, "JMU"); return; }
	if (!strcmp(airport, "晋江")) { strcpy(AIRPORT, "JJN"); return; }
	if (!strcmp(airport, "井冈山")) { strcpy(AIRPORT, "JGS"); return; }
	if (!strcmp(airport, "景德镇")) { strcpy(AIRPORT, "JDZ"); return; }
	if (!strcmp(airport, "九寨沟")) { strcpy(AIRPORT, "JZH"); return; }
	if (!strcmp(airport, "喀什")) { strcpy(AIRPORT, "KHG"); return; }
	if (!strcmp(airport, "卡拉奇")) { strcpy(AIRPORT, "KHI"); return; }
	if (!strcmp(airport, "库尔勒")) { strcpy(AIRPORT, "KRL"); return; }
	if (!strcmp(airport, "昆明")) { strcpy(AIRPORT, "KMG"); return; }
	if (!strcmp(airport, "拉萨")) { strcpy(AIRPORT, "LXA"); return; }
	if (!strcmp(airport, "兰州")) { strcpy(AIRPORT, "LHW"); return; }
	if (!strcmp(airport, "丽江")) { strcpy(AIRPORT, "LJG"); return; }
	if (!strcmp(airport, "连云港")) { strcpy(AIRPORT, "LYG"); return; }
	if (!strcmp(airport, "林芝")) { strcpy(AIRPORT, "LZY"); return; }
	if (!strcmp(airport, "柳州")) { strcpy(AIRPORT, "LZH"); return; }
	if (!strcmp(airport, "泸州")) { strcpy(AIRPORT, "LZO"); return; }
	if (!strcmp(airport, "马德里")) { strcpy(AIRPORT, "MAD"); return; }
	if (!strcmp(airport, "马尼拉")) { strcpy(AIRPORT, "MNL"); return; }
	if (!strcmp(airport, "满洲里")) { strcpy(AIRPORT, "NZH"); return; }
	if (!strcmp(airport, "曼谷")) { strcpy(AIRPORT, "BKK"); return; }
	if (!strcmp(airport, "孟买")) { strcpy(AIRPORT, "BOM"); return; }
	if (!strcmp(airport, "绵阳")) { strcpy(AIRPORT, "MIG"); return; }
	if (!strcmp(airport, "名古屋")) { strcpy(AIRPORT, "NGO"); return; }
	if (!strcmp(airport, "墨尔本")) { strcpy(AIRPORT, "MEL"); return; }
	if (!strcmp(airport, "幕尼黑")) { strcpy(AIRPORT, "MUC"); return; }
	if (!strcmp(airport, "南昌")) { strcpy(AIRPORT, "KHN"); return; }
	if (!strcmp(airport, "南京")) { strcpy(AIRPORT, "NKG"); return; }
	if (!strcmp(airport, "南宁")) { strcpy(AIRPORT, "NNG"); return; }
	if (!strcmp(airport, "南通")) { strcpy(AIRPORT, "NTG"); return; }
	if (!strcmp(airport, "宁波")) { strcpy(AIRPORT, "NGB"); return; }
	if (!strcmp(airport, "平壤")) { strcpy(AIRPORT, "FNJ"); return; }
	if (!strcmp(airport, "普吉")) { strcpy(AIRPORT, "HKT"); return; }
	if (!strcmp(airport, "齐齐哈尔")) { strcpy(AIRPORT, "NDG"); return; }
	if (!strcmp(airport, "青岛")) { strcpy(AIRPORT, "TAO"); return; }
	if (!strcmp(airport, "日喀则")) { strcpy(AIRPORT, "RKZ"); return; }
	if (!strcmp(airport, "三亚")) { strcpy(AIRPORT, "SYX"); return; }
	if (!strcmp(airport, "厦门")) { strcpy(AIRPORT, "XMN"); return; }
	if (!strcmp(airport, "汕头")) { strcpy(AIRPORT, "SWA"); return; }
	if (!strcmp(airport, "深圳")) { strcpy(AIRPORT, "SZX"); return; }
	if (!strcmp(airport, "沈阳")) { strcpy(AIRPORT, "SHE"); return; }
	if (!strcmp(airport, "台中")) { strcpy(AIRPORT, "RMQ"); return; }
	if (!strcmp(airport, "太原")) { strcpy(AIRPORT, "TYN"); return; }
	if (!strcmp(airport, "天津")) { strcpy(AIRPORT, "TSN"); return; }
	if (!strcmp(airport, "通辽")) { strcpy(AIRPORT, "TGO"); return; }
	if (!strcmp(airport, "万州")) { strcpy(AIRPORT, "WXN"); return; }
	if (!strcmp(airport, "威海")) { strcpy(AIRPORT, "WEH"); return; }
	if (!strcmp(airport, "温哥华")) { strcpy(AIRPORT, "YVR"); return; }
	if (!strcmp(airport, "温州")) { strcpy(AIRPORT, "WNZ"); return; }
	if (!strcmp(airport, "乌兰巴托")) { strcpy(AIRPORT, "ULN"); return; }
	if (!strcmp(airport, "乌兰浩特")) { strcpy(AIRPORT, "HLH"); return; }
	if (!strcmp(airport, "乌鲁木齐")) { strcpy(AIRPORT, "URC"); return; }
	if (!strcmp(airport, "无锡")) { strcpy(AIRPORT, "WUX"); return; }
	if (!strcmp(airport, "武汉")) { strcpy(AIRPORT, "WUH"); return; }
	if (!strcmp(airport, "西昌")) { strcpy(AIRPORT, "XIC"); return; }
	if (!strcmp(airport, "西宁")) { strcpy(AIRPORT, "XNN"); return; }
	if (!strcmp(airport, "悉尼")) { strcpy(AIRPORT, "SYD"); return; }
	if (!strcmp(airport, "锡林浩特")) { strcpy(AIRPORT, "XIL"); return; }
	if (!strcmp(airport, "仙台")) { strcpy(AIRPORT, "SDJ"); return; }
	if (!strcmp(airport, "香港")) { strcpy(AIRPORT, "HKG"); return; }
	if (!strcmp(airport, "襄樊")) { strcpy(AIRPORT, "XFN"); return; }
	if (!strcmp(airport, "新加坡")) { strcpy(AIRPORT, "SIN"); return; }
	if (!strcmp(airport, "徐州")) { strcpy(AIRPORT, "XUZ"); return; }
	if (!strcmp(airport, "雅典")) { strcpy(AIRPORT, "ATH"); return; }
	if (!strcmp(airport, "烟台")) { strcpy(AIRPORT, "YNT"); return; }
	if (!strcmp(airport, "延吉")) { strcpy(AIRPORT, "YNJ"); return; }
	if (!strcmp(airport, "盐城")) { strcpy(AIRPORT, "YNZ"); return; }
	if (!strcmp(airport, "扬州")) { strcpy(AIRPORT, "YTY"); return; }
	if (!strcmp(airport, "仰光")) { strcpy(AIRPORT, "RGN"); return; }
	if (!strcmp(airport, "宜宾")) { strcpy(AIRPORT, "YBP"); return; }
	if (!strcmp(airport, "宜昌")) { strcpy(AIRPORT, "YIH"); return; }
	if (!strcmp(airport, "义乌")) { strcpy(AIRPORT, "YIW"); return; }
	if (!strcmp(airport, "银川")) { strcpy(AIRPORT, "INC"); return; }
	if (!strcmp(airport, "运城")) { strcpy(AIRPORT, "YCU"); return; }
	if (!strcmp(airport, "湛江")) { strcpy(AIRPORT, "ZHA"); return; }
	if (!strcmp(airport, "张家界")) { strcpy(AIRPORT, "DYG"); return; }
	if (!strcmp(airport, "长春")) { strcpy(AIRPORT, "CGQ"); return; }
	if (!strcmp(airport, "长沙")) { strcpy(AIRPORT, "CSX"); return; }
	if (!strcmp(airport, "长治")) { strcpy(AIRPORT, "CIH"); return; }
	if (!strcmp(airport, "郑州")) { strcpy(AIRPORT, "CGO"); return; }
	if (!strcmp(airport, "重庆")) { strcpy(AIRPORT, "CKG"); return; }
	if (!strcmp(airport, "珠海")) { strcpy(AIRPORT, "ZUH"); return; }
	strcpy(AIRPORT, "没有匹配到机场信息");
	strcat(AIRPORT, airport);
	return;
}
